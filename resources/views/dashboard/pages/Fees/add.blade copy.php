...
@section('css')
    @toastr_css
@section('title')
    {{trans('Fees_trans.Add_StudyFees')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form method="post" action="{{ route('Fees.store') }}" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('Fees_trans.StudyFees Ar')}}</label>
                                <input type="text" value="{{ old('title_ar') }}" name="title_ar" class="form-control">
                            </div>

                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('Fees_trans.StudyFees En')}}</label>

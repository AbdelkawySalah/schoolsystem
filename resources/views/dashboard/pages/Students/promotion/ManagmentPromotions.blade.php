                    ...
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#rollback">
                                   تراجع الكل
                                </button>
                                <br><br>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"
                                                         ...
                                                         data-toggle="modal"
                                                         data-target="#rollbackpromotionstudent{{ $promotion->id }}" title="{{ trans('Students_trans.Rollbackstudent') }}">
                                                        {{ trans('Students_trans.Rollbackstudent') }}
                                                      </a>
                                                         
                                                </td>
                                            </tr>
                                            @include('dashboard.pages.Students.promotion.rollbackpromotions')
                                            @include('dashboard.pages.Students.promotion.rollbackpromotionstudent')

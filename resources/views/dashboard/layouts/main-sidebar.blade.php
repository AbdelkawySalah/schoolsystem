 ...
 <li>
                    ...
                    <li>
                        ...
                        <ul id="students-menu" class="collapse">
                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" data-target="#Student_information">{{trans('main_sidebar_trans.Student_information')}}<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                            ...
                            <li>
                                ...
                                <ul id="Students_upgrade" class="collapse">
                                    ...
                                    <li> <a href="{{route('Promotion.create')}}">{{trans('main_sidebar_trans.Managment_Student_Promotions')}}</a> </li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" data-target="#Students_Graduated">{{trans('main_sidebar_trans.Students_Graduated')}}<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                                <ul id="Students_Graduated" class="collapse">
                                    <li> <a href="{{route('Graduated.create')}}">{{trans('main_sidebar_trans.Add_Graduated')}}</a></li>
                                    <li> <a href="{{route('Graduated.index')}}">{{trans('main_sidebar_trans.Graduated_List')}}</a> </li>
                                </ul>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                           <li><a href="{{route('FeesType.index')}}">{{trans('main_sidebar_trans.Fees Type')}}</a></li>
                            <li> <a href="{{route('Fees.index')}}">{{trans('main_sidebar_trans.Study Fees')}}</a> </li>
                            <li> <a href="{{route('Fees_Invoices.index')}}">الفواتير الدراسية للطلاب</a></li>
                            <li> <a href="{{route('receipt_students.index')}}">سندات القبض  للطلاب</a></li>

                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                   ...
                   <!-- end parents bar -->
                     ...
                     <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu2">
                            <div class="pull-left"><i class="ti-home"></i>
                            <span class="right-nav-text">
                            {{trans('main_sidebar_trans.Teachers')}}
                           </span>
                          </div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        ...
                        <ul id="calendar-menu2" class="collapse" data-parent="#sidebarnav">
                            <li>
                            <a href="{{route('Teacheers.index')}}">
                            {{trans('main_sidebar_trans.List_Teachers')}}
                            </a> 
                            </li>
                        </ul>
                    </li>
                   ...
                   <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu3">
                            <div class="pull-left"><i class="ti-home"></i>
                            <span class="right-nav-text">
                            {{trans('main_sidebar_trans.Students')}}
                           </span>
                          </div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        ...
                        <ul id="calendar-menu3" class="collapse" data-parent="#sidebarnav">
                            ...
                            {{trans('Student_trans.Student_List')}}
                            </a> 
                            </li>
                            <li>
                            <a href="{{route('Student.create')}}">
                            {{trans('main_sidebar_trans.add_Student')}}
                            </a> 
                            </li>
                            <li>
                            <a href="{{route('Promotion.index')}}">
                              {{trans('main_sidebar_trans.Student_Promotions')}}
                            </a> 
                            </li>
                        </ul>
                    </li>
